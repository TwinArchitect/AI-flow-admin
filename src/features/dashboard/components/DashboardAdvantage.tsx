  ...
  return (
    <section className="space-y-6">
      <div className="text-center max-w-2xl mx-auto space-y-2">
        ...
        <h2 className="text-3xl font-black tracking-tight text-foreground">智能体平台的六大核心优势</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
        {advantages.map((ad) => (
          <Card
            ...
            className="relative flex items-start gap-4 overflow-hidden rounded-2xl border-border bg-card p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
          >
            {/* 左侧高亮色条 */}
