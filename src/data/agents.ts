...
export const statusConfig = {
  ...
  paused: { label: '已暂停', dotClass: 'bg-warning', badgeClass: 'bg-warning/10 text-warning' },
  error: { label: '异常', dotClass: 'bg-destructive', badgeClass: 'bg-destructive/10 text-destructive' },
};
